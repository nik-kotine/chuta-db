...
class Node(object):
    ...
    def index(self, key):
        # retorna el idx en donde debe estar la key
    ...
    def split(self):
        # divide al nodo y guarda sus mitades como nodos hijos
        # un valor del hijo sube
    ...
    def fusion(self):
        ...
        else:  # si estamos en el ultimo nodo, lo mergeamos con el anterior
...
class Leaf(Node):
    ...
    def split(self):
        ...
        # cuando la hoja se divide, 
        # seteamos la llave del padre a la llave mas a la izq del hijo derecho.
...
class BPlusTree(object):
    ...
    def insert(self, key, value):
        leaf = self.find(key)
        if key in leaf.keys:
            raise ValueError(f"KeyValue {key} already exists!")
        else:
